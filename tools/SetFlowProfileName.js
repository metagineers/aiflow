...
async function call({ name = 'Flow is the best' }) {
...
class SetFlowProfileName extends Tool {
  name = 'set-flow-profile-name';
  
  description = `Set the profile name of my Flow blockchain profile smart contract. The action input should adhere to this JSON schema:
  {{
    "type": "object",
    "properties": {{
      "name": {{
        "type": "string",
        "description": "The profile name to set to"
      }}
    }},
    "required": ["name"]
  }}`;
...
export default SetFlowProfileName;